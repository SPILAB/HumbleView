...
class SizeListActivity : AppCompatActivity() {
    ...
    private var listA = UrlsWithSizes(listOf(
    ...
    private var listB = UrlsWithSizes(listOf(
    ...
    private var listC = UrlsWithSizes(listOf(
    ...
    private var listD = UrlsWithSizes(listOf(
