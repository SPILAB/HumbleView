...
class SizeListActivity : AppCompatActivity() {
    ...
    private var listA: SizeList
    private var listB: SizeList
    private var listC: SizeList
    private var listD: SizeList

    init {
        listA = SizeList(listOf(
